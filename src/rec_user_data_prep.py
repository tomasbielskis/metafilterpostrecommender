...
if __name__ == '__main__':
    ...
    user_data = user_data.append(user_fav_post_features_train2.drop('postid',axis=2))

    user_fav_comment_features_train2 = pd.read_json(path+'user_fav_comment_features_train2')
    user_data = user_data.append(user_fav_comment_features_train2.drop('commentid',axis=2))

    user_fav_comment_features_test2 = pd.read_json(path+'user_fav_comment_features_test2')
    user_data = user_data.append(user_fav_comment_features_test2.drop('commentid',axis=2))

    user_fav_post_features_test2 = pd.read_json(path+'user_fav_post_features_test2')
    user_data = user_data.append(user_fav_post_features_test2.drop('postid',axis=2))
